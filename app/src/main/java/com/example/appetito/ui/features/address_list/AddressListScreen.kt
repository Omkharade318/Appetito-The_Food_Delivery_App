package com.example.appetito.ui.features.address_list
...
import com.example.appetito.ui.features.cart.AddressCard
...
fun AddressListScreen(
    ...
    val isAddressAdded = navController.currentBackStackEntry?.savedStateHandle?.getStateFlow("isAddressAdded", false)?.collectAsState(false);
